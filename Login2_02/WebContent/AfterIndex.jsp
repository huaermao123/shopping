...
<html>
	...
	<form action="gwcServlet">
		...
		<div id="ssl">
			...
			<div><a href="gwc.jsp">我的购物车</a></div>
		</div>
	    ...
	    <div id="geirenxx">
	    	<p><a onclick="javascript:window.location.href='updateConsServlet?name1=${namePsw.loginname}'">修改密码</a></p>
		...
		<div id="_iframe">
			<iframe id="_iframe_nr" src="getProPage?pageNo=1&pageSize=7"></iframe>
		</div>
		</form>
	</body>
</html>
