			...
			<div id="kuang1">
				...
				<table   width="1000px" height="370px" border="0px" cellpadding="0px" cellspacing="0px">
					<tr>
						...
						<td><input name="pname" id="input01" type="text" placeholder="鱼"/></td>
					</tr>
					<tr>
					...
					<tr>
						<td class="td01">商品是否上线:</td>
						<td>
							<input  id="checkbox_" type="radio" name="ss" value="1"  onclick="te()"/>上线
						    <input type="radio" value="2" name="ss"/>下线
						</td>
					</tr>
					<tr>
						<td class="td01">重量</td>
