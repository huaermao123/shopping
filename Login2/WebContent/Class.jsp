...
<html>
	...
	<body>
		...
		<div id="address">
			...
			<div id="add_lm"> <input type="text" placeholder="添加商品的子类" name="cate_id2"/>
			 ...
			 <c:forEach items="${ddlist}" var="item" varStatus="status">  
			  ...
			  <button onclick="javascript:window.location.href='AddChild'">添加</button>
 			</div>	
		</div>	
		...
		<div id="table_">
          ...
          if(obj!=null){// 
              ...
              <tr> 	  
				...
				<a onclick="javascript:window.location.href='delNodeServlet?cid=<%=pageModel.getDatas().get(i).getCid() %>'">删除</a> <img style="width: 15px;height: 15px;" src="img/shanchu.png"/></td>	
		...
		<div id="page">
			...
			<a href="CateServlet?pageNo=<%=pageModel.getPageNo()-1==0?pageModel.getPageNo():pageModel.getPageNo()-1%>&pageSize=5">上页</a>
			<a href="CateServlet?pageNo=<%=pageModel.getPageNo()+1==pageModel.getTotalPageSize()+1?pageModel.getTotalPageSize():pageModel.getPageNo()+1 %>&pageSize=5">下页</a>
